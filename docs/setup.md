...
export TF_VAR_mlflow_db_password= 
export TF_VAR_mlflow_db_username= 
...
myfiles/MyProjects/ml-engineering/infra/terraform/environments/dev
terraform apply

```
# todo: need second apply as autoscale not auth.
...
kubectl apply -f /mnt/c/Myfiles/MyProjects/ml-engineering/infra/kubernetes/bootstrap/root-app.yaml
...
#
kubectl port-forward svc/ml-inference -n inference 8000:8000